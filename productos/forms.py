...
class EditarProductosForm(forms.ModelForm):
    class Meta:
        model = producto
        fields = [
            'nombre_producto',
        ...
        widgets = {
            'nombre_producto': forms.TextInput(attrs={'class': 'form-control'}),
            'desc_beneficio': forms.Textarea(attrs={'class': 'form-control', 'rows': '5', 'cols': '50'}),
            'fecha_registro': forms.DateInput(attrs={'class': 'form-control', 'readonly': 'readonly'}),
            'id_organizacion': forms.HiddenInput(attrs={'class': 'form-control', 'readonly': 'readonly'}),
        }

class EditarPresentacionesProductosForm(forms.ModelForm):
    class Meta:
        model = presentacion
        fields = [
            'nombre_presentacion',
        ...
        widgets = {
            ...
            'id_unidad_medida': forms.Select(attrs={'class': 'form-control'}),
            'id_categoria': forms.Select(attrs={'class': 'form-control'}),
            'id_producto': forms.HiddenInput(attrs={'class': 'form-control', 'readonly': 'readonly'}),
        }